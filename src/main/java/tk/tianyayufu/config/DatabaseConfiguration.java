...
import tk.tianyayufu.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("tk.tianyayufu.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("tk.tianyayufu.repository.search")
